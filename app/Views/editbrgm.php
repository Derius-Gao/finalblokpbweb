...
<div class="container mt-3">
  <form action="<?= base_url('home/simpan_barangm') ?>" method="post">
      <div class="mp-3">
      <label for="tanggal_diterima">tanggal_diterima Barang :</label>
      <input type="date" class="form-control" id="tanggal_diterima" placeholder="Enter tanggal_diterima" name="tanggal_diterima"value="<?= $marah->tanggal_diterima?>">
    </div>
    <div class="mq-3">
    ...
    <tr>
      ...
      <td><input type="hidden" name="id" value="<?= $marah->id_barang ?>">
        ...
        <a href="<?= base_url('home/hapus_barangm/'.$marah->id_barang) ?>" class="btn btn-danger">Hapus </a>
    </tr>
  </form>
</div>
