...
<div class="container mt-3">
  <form action="<?= base_url('home/simpan_transaksi') ?>" method="post">
    <div class="mp-3">
      ...
      <input type="text" class="form-control" id="kode" placeholder="Enter code " name="kode" value="<?=$marah->kode_transaksi?>">
    </div>
    <div class="mq-3">
      <label for="tanggal">Tanggal transaksi :</label>
      <input type="date " class="form-control" id="tanggal" placeholder="Enter tanggal " name="tanggal" value="<?=$marah->tanggal_transaksi?>">
    </div>
    <div class="ml-3">
   ...
   <tr>
      ...
      <td><input type="hidden" name="id" value="<?= $marah->id_nota ?>">
        ...
        <a href="<?= base_url('home/hapus_transaksi/'.$marah->id_nota) ?>" class="btn btn-danger">Hapus </a>
