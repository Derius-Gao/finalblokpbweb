...
<main id="main" class="main">
   ...
   <form class="mt-4" action="<?= base_url('home/lbarangk_1')?>" method="POST">
    <table>
      <tr>
        <td>tanggal awal</td>
      ...
      <tr>
        ...
        <button class="btn btn-info">
           ...
           <form class="mt-4" action="<?= base_url('home/pdflapor_bk')?>" method="POST" target="_blank">
             <tr>
        <td>tanggal awal</td>
      ...
      <tr>
        ...
        <form class="mt-4" action="<?= base_url('home/excellapor_bk')?>" method="POST" target="_blank">
           <tr>
        <td>tanggal awal</td>
