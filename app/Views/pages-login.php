...
<style>
    /* Apply background to the login section */
    .section.register {
      background-image: url('<?= base_url('img/skibidi.jpeg')?>');
...
background-size: auto;
    ...
    /* Change the background color of the login card */
    .card {
    ...
    /* Change the login button colors */
    .btn-primary {
      background-color: #10db8e;
      border-color: #10db8e;
      color: white;
    }
    ...
    /* Change the text color for title and description */
    .card-title {
      color: #007bff;
    }
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  <img src="<?= base_url('img/ada.jfif')?>" alt="">
